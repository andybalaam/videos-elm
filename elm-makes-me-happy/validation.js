...
var author$project$Validation$validEmail1 = function (model) {
	return (model.email1 === '') ? author$project$Validation$Empty : (A2(elm$core$String$contains, '@', model.email1) ? author$project$Validation$Valid : author$project$Validation$Invalid);
};
...
var author$project$Validation$main = elm$browser$Browser$sandbox(
	{init: author$project$Validation$init, update: author$project$Validation$update, view: author$project$Validation$view});
_Platform_export({'Validation':{'init':author$project$Validation$main(
