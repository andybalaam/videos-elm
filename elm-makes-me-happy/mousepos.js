...
Elm.MousePos = Elm.MousePos || {};
Elm.MousePos.make = function (_elm) {
   "use strict";
   _elm.MousePos = _elm.MousePos || {};
   if (_elm.MousePos.values) return _elm.MousePos.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   var _op = {};
   var main = A2($Signal.map,$Graphics$Element.show,$Mouse.position);
   return _elm.MousePos.values = {_op: _op,main: main};
};
